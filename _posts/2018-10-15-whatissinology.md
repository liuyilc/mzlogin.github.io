...
视域的要素据说是包含了观察主体和观察客体，还有方向的。方向一定要不一样，视域才会不一样吗？显然不是。

举一个例子。一个人在前，一个人在后，两人使用完全相同的设备，他们照出来的照片也是有区别的，因为后面那个人站得比前面一个人离观察对象要远。

另外一个例子是。假设理论上两人为一点，焦段相同，但一个用全副，一个用残幅，照出来的照片还是会有区别。

除了照片视域的范围，还有清晰度的问题。在第一个例子中，如果站在后面的那个人不使用自动对焦，并保持同前一个人的焦段一致，那么他的照片显然要比前一个人的模糊。

而远近这一组概念在研究中意味着什么呢？就从文本而言，远观可以看到它表面的风格，而近看可以看到互文关系，乃至每个词的词源（尤其指新批评）。另外，如果近看时，相机恰好能捕捉到一个刚好完整的对象，那么站在后面的，也就是离对象较远的那个人，能够看到除了对象以外的那个东西。而那个东西是否和对象有所关联？这又是后面要考虑的问题了。

- 20181103

所谓视域，或许用坐标系解释更好。坐标系展示的就是研究者的位置。
